                      ...
                      </View> 
                        {
                          !isKeyboardVisible && (
                            ...
                            <View style={{alignContent:'center',alignItems:'center',marginTop:50}}>
                              ...
                              <Text style={[styles.textPulsa,{fontFamily:fonts.regular.fontFamily,marginTop:10}]}>
                              ¿Te has olvidado tu contraseña?{' '}
                              <TouchableOpacity onPress={() => rescuperarpass()}>
                                <Text style={[styles.linkText,{fontFamily:fonts.regular.fontFamily}]}>Recuperar.</Text>
                              </TouchableOpacity>
                              </Text>

                              <Text style={{color: colors.text,fontSize:12,marginTop:50,fontFamily:fonts.regular.fontFamily,color: 'rgba(218,165,32,0.7)',}}> Versión {versionsys} </Text>
